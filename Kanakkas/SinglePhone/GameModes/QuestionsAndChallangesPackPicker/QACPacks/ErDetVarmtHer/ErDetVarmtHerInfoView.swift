...
struct ErDetVarmtHerInfoView: View {
        ...
        ZStack {
            ...
            VStack {
                ...
                TabView(selection: $currentPage) {
                    ...
                    infoPage(
                        title: "Stripp!",
                        description: "Siden dere er så jævla heite og kleine kan vi vel liksågodt strippe litt!"
                    )
                    .tag(8)
                }
...
// MARK: - Preview
struct ErDetVarmtHerIngoView_Previews: PreviewProvider {
    static var previews: some View {
        ErDetVarmtHerInfoView(dismiss: {})
    }
}
