...
struct VorsetStarterInfoView: View {
        ...
        ZStack {
            ...
            VStack {
                ...
                TabView(selection: $currentPage) {
                    ...
                    infoPage(
                        title: "📜 Vorset Starter! 📜",
                        description: """
                        Kvelden begynner her og nå!
                        
                        Kjør på med spørsmål og utfordringer ment for alt og alle!
                        
                        Bli kjent med hverandre på nye måter!
                        """
                    )
                    .tag(0)
...
// MARK: - Preview
struct VorsetStarterInfoView_Previews: PreviewProvider {
    static var previews: some View {
        VorsetStarterInfoView(dismiss: {})
    }
}
