...
struct AllInGuttaInfoView: View {
            ...
            VStack {
                ...
                TabView(selection: $currentPage) {
                    ...
                    infoPage(
                        title: "📜 All-in gutta! 📜",
                        description: """
                        Her skal gutta kjøres hardt! 
                        
                        En god blandig spørsmål og utfordringer for å gi gutta god stemining før byen!
                        """
                    )
                    .tag(0)
...
// MARK: - Preview
struct AllInGuttaInfoView_Previews: PreviewProvider {
    static var previews: some View {
        AllInGuttaInfoView(dismiss: {})
    }
}
