            ...
            VStack {
                ...
                TabView(selection: $currentPage) {
                    ...
                    infoPage(
                        title: "📜 Dag 2! 📜",
                        description: """
                        Det er dag 2 av drinks! 
                        
                        vi begynner lett før det kjøres hardere enn i går!
...
// MARK: - Preview
struct Dag2InfoView_Previews: PreviewProvider {
    static var previews: some View {
        Dag2InfoView(dismiss: {})
    }
}
