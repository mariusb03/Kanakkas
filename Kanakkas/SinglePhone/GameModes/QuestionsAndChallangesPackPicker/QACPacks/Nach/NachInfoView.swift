            ...
            VStack {
                ...
                TabView(selection: $currentPage) {
                    ...
                    infoPage(
                        title: "📜 nach! 📜",
                        description: """
                        Dere hadde altså ikke lyst å gi dere? 
                        
                        jaja, her får dere spørsmål og utfordringer for å runde av kvelden!
                        """
                    )
                    .tag(0)
...
// MARK: - Preview
struct NachInfoView_Previews: PreviewProvider {
    static var previews: some View {
        NachInfoView(dismiss: {})
    }
}
