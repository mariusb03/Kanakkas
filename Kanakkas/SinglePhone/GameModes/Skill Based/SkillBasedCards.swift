...
let skillBasedCards: [SkillBasedCard] = [
    ...
    SkillBasedCard(title: "10 sprett!", description: "Finn frem en bordtenninsball (eller flere)! \n spillet er ment for 2 personer, men snu om på reglene om dere vil være flere! \n begynn med å sprette ballen én gang over bordet til neste spiller! Neste person skal så sprette den to ganger tilbake (eller til neste spille), så tre, så fire og så videre! Dere skal gjøre dette til dere når 10 spretter! \n spretter ballen for eksempel mer eller mindre enn tre ganger når den skal sprette 3 ganger, drikker den som kastet ballen og dere begynner på nytt fra en! ", category: "kategori", needsPlayer: false)
]
